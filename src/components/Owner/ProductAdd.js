...
//---------add Product------------- 
    ...
    const Product = {title,description,price,productImg,category,quantity,status};

	axios.post(`http://localhost:3030/Product/addProduct`,Product)
...
<div className="font-sans">
 ...
 <label htmlFor className="block text-sm text-gray-700 text-center font-bold">
        ...
        <form method="#" action="#" className="mt-10" onSubmit={handleSubmit}>
          <div className="mt-7">
            <input type="text" placeholder="title" className="mt-1 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0"  required 
            value={title}
